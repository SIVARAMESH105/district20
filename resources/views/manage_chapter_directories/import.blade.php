  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="card card-primary">
        <form role="form" id="add-directory" action="{{ route('manage-chapter-directories-import') }}" name="add-directory" method="POST" enctype="multipart/form-data">
          @csrf 
          ...
          <div class="card-footer">
            ...
            <a class="text-right" href="{{ asset('sample-excel-files/Sample-chapter-Directory-Data-File.xlsx') }}" style="float: right;"><i class="fas fa-download"></i> Sample File</a>
          </div>
        </form>
      </div>
    </div>
