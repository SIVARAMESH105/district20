  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="card card-primary">
        <form role="form" id="add-document-type" action="{{ route('manage-document-type-save') }}" name="add-document-type" method="POST">
          @csrf
          <div class="card-body">
            <div class="form-group">
              <label for="name">Document Type Name<span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="name" name="name" placeholder="Enter Document Type Name" value="{{ old('name') }}">
            </div>                    
          </div>
