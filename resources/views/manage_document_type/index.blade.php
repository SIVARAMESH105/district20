  ...
  <div class="row">        
    <div class="col-lg-12 col-12">
      ...
      <div class="table-responsive">
        <div class="offset-8 col-sm-4 text-right" style="padding: 10px;"><a href="{{ route('manage-document-type-add') }}" class="btn btn-info btn-sm">Add Document Type</a></div>
        <table id="manage-document-type" class="table table-bordered">
          <thead>
...
<script type="text/javascript" src="{{ asset('custom/datatables_custom.js') }}"></script>
 <script type="text/javascript">
    var thData = [
                    {data: 'document_type_name', name: 'document_type_name'},    
                    {data: 'action', name: 'action', sortable: false},
                  ];
  </script>
<script type="text/javascript">
$(document).ready(function() {
  $('#manage-document-type').DataTable({
    "processing": true,
    "serverSide": false,
    "pageLength": 25,
    "searching":   true,
    ...
    "aaSorting": [],
    "order": [[ 0, "asc" ]],
    "ajax": "{{ route('getDocumentTypeListAjax') }}",
    "columns": thData
  });
        ...
        $.ajax({
                ...
                success: function (data) {
                  if(data){
                    ...
                    $('#manage-document-type').DataTable().draw();
                  }
                }
              });
        }
