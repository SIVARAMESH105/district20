  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="card card-primary">
        <form role="form" id="add-contractor-resources" action="{{ route('manage-contractor-resources-save') }}" name="add-contractor-resources" method="POST" enctype="multipart/form-data">
          @csrf 
          <div class="card-body row">
            ...
            <div class="col-12 form-group">
              ...
              <textarea id="description" class="form-control" rows="4" name="description" placeholder="Enter Description" value="{{ old('description') }}"></textarea>
            </div>
            <div class="col-12 form-group">
