    ...
    <div class="row">
        <div class="col-lg-12 col-12">
            <ul class="nav nav-tabs" >
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-content-below-list-tab" data-toggle="pill" href="#custom-content-below-list" role="tab" aria-controls="custom-content-below-home" aria-selected="true">List</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-content-below-map-tab" data-toggle="pill" href="#custom-content-below-map" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Map</a>
                  </li>     
            </ul>
            <div class="tab-content" id="custom-content-below-tabContent">
                <div class="tab-pane fade show active" id="custom-content-below-list" role="tabpanel" aria-labelledby="custom-content-below-list-tab">
                    <br>
                    @if (count($errors) > 0)
                ...
                <div class="tab-pane fade" id="custom-content-below-map" role="tabpanel" aria-labelledby="custom-content-below-map-tab">
                    <div id="statesMap">
                      <p>I am test</p>
                </div>
            </div>
