            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="table-responsive">
                    <div class="offset-8 col-sm-4 text-right" style="padding: 10px;">
                        <a href="{{ route('manage-contractor-directories-add') }}" class="btn btn-info btn-sm">Add Contractor Directory</a>
                    </div>
                    @if(AdminHelper::checkUserIsSuperAdmin())
                    <div class="offset-8 col-sm-4 text-right" style="padding: 10px;">
                        <a href="{{ route('manage-contractor-directories-import') }}" class="btn btn-info btn-sm">Import Contractor Directory</a>
                    </div>
                    @endif
...
$(document).ready(function() {
  $('#manage-contractor-directories').DataTable({
    ...
    "aaSorting": [],
    "order": [[ 0, "desc" ]],
    "ajax": "{{ route('getdirectoriesListAjax') }}",
    "columns": [
                  {data: 'name', name: 'name'},
        ...
        $.ajax({
                  ...
                  success: function (data) {
                    if(data){
                       swal({
                        title: "Success",
                        text: "Contractor Directory Deleted Successfully.",
                        type: "success",
                        confirmButtonColor: "#22D69D"
                    });
                      $('#manage-contractor-directories').DataTable().draw();
                    }
                  }
              });
        }
