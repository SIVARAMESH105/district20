        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('manage-contractor-directories') }}">Manage Contractor Directory</a></li>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card card-primary">
        <form role="form" id="add-directories" action="{{ route('manage-contractor-directories-update') }}" name="add-directories" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="card-body row">
            ...
            @else
              <input type="hidden" class="form-control" id="chapter" name="chapter" value="{{ $info->chapter_id ?$info->chapter_id:Auth::user()->chapter_id }}">
            @endif
            <div class="col-6 form-group">
            ...
            <div class="col-6 form-group">
              ...
              <input type="text" class="form-control" id="state" name="state" placeholder="Enter State" value="{{ old('state')?old('state'):$info->state }}">
            </div>
            <div class="col-6 form-group">
          ...
          <div class="card-footer">
            ...
            <a href="{{ route('manage-contractor-directories') }}" class="btn btn-secondary">Cancel</a>
          </div>
        </form>
      </div>
    </div>
