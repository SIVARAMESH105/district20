            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="table-responsive">
                    <div class="offset-8 col-sm-4 text-right" style="padding: 10px;">
                        <a href="{{ route('manage-jatc-directories-add') }}" class="btn btn-info btn-sm">Add Jatc Directory</a>
                    </div>
                    @if(AdminHelper::checkUserIsSuperAdmin())
                    <div class="offset-8 col-sm-4 text-right" style="padding: 10px;">
                        <a href="{{ route('manage-jatc-directories-import') }}" class="btn btn-info btn-sm">Import Jatc Directory</a>
                    </div>
                    @endif
                    <table id="manage-jatc-directories" class="table table-bordered">
                        <thead>
                            <th>Contact Name</th>
                            <th>Position</th>
                          <!--   <th>Address</th> -->
...
$(document).ready(function() {
  $('#manage-jatc-directories').DataTable({
    "processing": false,
    "serverSide": true,
    "pageLength": 25,
    "searching":   true,
    ...
    "aaSorting": [],
    "order": [[ 0, "desc" ]],
    "ajax": "{{ route('getJatcDirectoriesListAjax') }}",
    "columns": [ 
        ...
        $.ajax({
                  ...
                  success: function (data) {
                    if(data){
                       swal({
                        title: "Success",
                        text: "Jatc Directory Deleted Successfully.",
                        type: "success",
                        confirmButtonColor: "#22D69D"
                    });
                      $('#manage-jatc-directories').DataTable().draw();
                    }
                  }
              });
        }
