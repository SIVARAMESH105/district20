        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('manage-jatc-directories') }}">Manage Jatc Directory</a></li>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card card-primary">
        <form role="form" id="add-directories" action="{{ route('manage-jatc-directories-update') }}" name="add-directories" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="card-footer">
            ...
            <a href="{{ route('manage-jatc-directories') }}" class="btn btn-secondary">Cancel</a>
          </div>
        </form>
      </div>
    </div>
