  ...
  <div class="row">        
    <div class="col-lg-12 col-12">
      ...
      <div class="table-responsive">
        <div class="offset-8 col-sm-4 text-right" style="padding: 10px;"><a href="{{ route('manage-notification-add') }}" class="btn btn-info btn-sm">Add Notification</a></div>
        <table id="manage-notification" class="table table-bordered">
          <thead>
            <th>Title</th>
            <th>Link</th>
            <th>Action</th>
...
$(document).ready(function() {
  $('#manage-notification').DataTable({
    ...
    "aaSorting": [],
    "order": [[ 0, "asc" ]],
    "ajax": "{{ route('getNotificationListAjax') }}",
    "columns": thData
  });
        ...
        $.ajax({
                ...
                success: function (data) {
                  if(data){
                    ...
                    $('#manage-notification').DataTable().draw();
                  }
                }
              });
        }
