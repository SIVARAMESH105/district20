            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="table-responsive">
                    <div class="offset-8 col-sm-4 text-right" style="padding: 10px;">
                        <a href="{{ route('manage-ibew-directories-add') }}" class="btn btn-info btn-sm">Add Ibew Directory</a>
                    </div>
                    <div class="offset-8 col-sm-4 text-right" style="padding: 10px;">
                        <a href="{{ route('manage-ibew-directories-import') }}" class="btn btn-info btn-sm">Import Ibew Directory</a>
                    </div>
                    <table id="manage-ibew-directories" class="table table-bordered">
                        <thead>
                            <th>Name</th>
                            <th>Position</th>
                          <!--   <th>Address</th> -->
...
$(document).ready(function() {
  $('#manage-ibew-directories').DataTable({
    "processing": false,
    "serverSide": true,
    "pageLength": 25,
    "searching":   true,
    ...
    "aaSorting": [],
    "order": [[ 0, "desc" ]],
    "ajax": "{{ route('getIbewDirectoriesListAjax') }}",
    "columns": [
                  {data: 'name', name: 'name'},
        ...
        $.ajax({
                  ...
                  success: function (data) {
                    if(data){
                       swal({
                        title: "Success",
                        text: "Ibew Directory Deleted Successfully.",
                        type: "success",
                        confirmButtonColor: "#22D69D"
                    });
                      $('#manage-ibew-directories').DataTable().draw();
                    }
                  }
              });
        }
