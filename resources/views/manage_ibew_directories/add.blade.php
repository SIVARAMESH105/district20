  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card card-primary">
        <form role="form" id="add-directory" action="{{ route('manage-ibew-directories-save') }}" name="add-directory" method="POST" enctype="multipart/form-data">
          @csrf 
            ...
            <div class="col-6 form-group">
              ...
              <select type="text" class="form-control" id="district" name="district">
                ...
                @foreach($districts as $district)
                  <option value="{{ $district->value }}" {{ $district->value==old('district') ? 'selected' : ''}}>{{ $district->name }}</option>
                @endforeach
              </select>
            </div>
            <div class="col-6 form-group">
            ...
            <div class="col-6 form-group">
              ...
              <select type="text" class="form-control" id="state" name="state">
                ...
                @foreach($stateCodes as $stateCode)
                  <option value="{{ $stateCode->value }}" {{ $stateCode->value==old('state') ? 'selected' : ''}}>{{ $stateCode->name }}</option>
                @endforeach
              </select>
            </div>
            <div class="col-6 form-group">
